function BOSS_LoadData()
    BOSS_DATA = {
        [BOSS_PLAGUE_CULT] = {
            ...
            ,regions = {
                arena = {
                    Rect(-1792.0, 11296.0, 3584.0, 12000.0)
                    ,Rect(-1664.0, 11968.0, 3456.0, 12128.0)
                    ,Rect(-1504.0, 12096.0, 3296.0, 12256.0)
                    ,Rect(-1376.0, 12224.0, 3168.0, 12384.0)
                    ,Rect(-1248.0, 12352.0, 3040.0, 12512.0)
                    ,Rect(-1120.0, 12480.0, 2912.0, 12640.0)
                    ,Rect(-992.0, 12608.0, 2816.0, 12768.0)
                    ,Rect(-864.0, 12736.0, 2656.0, 12896.0)
                    ,Rect(-736.0, 12864.0, 2528.0, 13024.0)
                    ,Rect(-608.0, 12992.0, 2432.0, 13152.0)
                    ,Rect(-480.0, 13120.0, 2304.0, 13280.0)
                    ,Rect(-384.0, 13248.0, 2176.0, 13408.0)
                    ,Rect(-256.0, 13376.0, 2048.0, 13536.0)
                    ,Rect(-128.0, 13504.0, 1920.0, 13664.0)
                    ,Rect(0.0, 13632.0, 1792.0, 13792.0)
                    ,Rect(128.0, 13760.0, 1664.0, 13920.0)
                    ,Rect(256.0, 13888.0, 1536.0, 14048.0)
                    ,Rect(384.0, 14016.0, 1408.0, 14176.0)
                    ,Rect(512.0, 14144.0, 1280.0, 14304.0)
                    ,Rect(640.0, 14272.0, 1152.0, 14432.0)
                    ,Rect(768.0, 14400.0, 1024.0, 14560.0)
                }
