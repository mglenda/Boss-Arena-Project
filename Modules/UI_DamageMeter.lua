...
function DamageMeter_Initiate()
    ...
    TriggerAddAction(DMGMETER_COMBAT_TIMER, function()
        DMGMETER_COMBAT_DURATION = not(ARENA_ACTIVATED) and DMGMETER_COMBAT_DURATION + 1 or FIGHT_DATA.RECORD_DURATION
        DMGMETER_COMBAT_PERIOD = not(ARENA_ACTIVATED) and DMGMETER_COMBAT_PERIOD + 1 or 0
